//UIUC CS125 FALL 2014 MP. File: RainGame.java, CS125 Project: PairProgramming, Version: 2015-02-23T22:30:05-0600.038180596
/**
 * @author lai34
 */
public class RainGame {
	...
	public static void main(String[] args) {
		...
		while (Zen.isRunning()) {
			...
			int scoreboardPositionY = 50;
			
			Zen.drawText("Level: "+(score/50),10,scoreboardPositionY);
			Zen.drawText("Score: "+score,10,scoreboardPositionY+50);
			
			x += dx;
			y += dy;
			if (y==Zen.getZenHeight()) Zen.closeWindow();
